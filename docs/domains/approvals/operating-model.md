...
The Approval context owns human-in-the-loop high-impact decisions. Tenant scope, actor accountability, correlation identifiers, and policy checks are explicit in its contracts.
