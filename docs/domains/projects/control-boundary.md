...
The Project context owns tenant-aware engineering project orchestration. Tenant scope, actor accountability, correlation identifiers, and policy checks are explicit in its contracts.
