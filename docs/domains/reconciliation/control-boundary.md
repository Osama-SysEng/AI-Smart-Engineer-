# Reconciliation: control boundary

## Responsibility

The Reconciliation context owns cross-source comparison and deterministic evidence. Tenant scope, actor accountability, correlation identifiers, and policy checks are explicit in its contracts.
