...
The Document context owns ingestion, extraction, retention, and evidence. Tenant scope, actor accountability, correlation identifiers, and policy checks are explicit in its contracts.
